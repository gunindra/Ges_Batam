...
class CashFlowController extends Controller
{
    ...
    $financingAccount = DB::select("SELECT coa.name AS account_name,
        ...
        if ($total_beginning_balance >= 0){
            ...
            $output .= '<td class="text-right"><h5><b>' . number_format($total_beginning_balance * -1, 2) . '</b></h5></td></tr></thead></table>';
        }
        ...
        foreach ($operationsAccount as $data) {
            ...
            $output .= ' <tr> <td>' . ($data->account_name ?? '-') . '</td>';
        ...
        if ($operations_end_balance >= 0){
            $output .= '<td class="text-right"> <b>' . number_format($operations_end_balance, 2) . '</b> </td> </tr>';
        }
        else{
            $output .= '<td class="text-right"> <b>' . number_format($operations_end_balance * -1, 2) . '</b> </td> </tr>';
        }
        ...
        if ($investing_end_balance >= 0){
            $output .= '<td class="text-right"> <b>' . number_format($investing_end_balance, 2) . '</b> </td> </tr>';
        }
        else{
            $output .= '<td class="text-right"> <b>' . number_format($investing_end_balance * -1, 2) . '</b> </td> </tr>';
        }
        ...
        if ($financing_end_balance >= 0){
            $output .= '<td class="text-right"> <b>' . number_format($financing_end_balance, 2) . '</b> </td> </tr>';
        }
        else{
            $output .= '<td class="text-right"> <b>' . number_format($financing_end_balance * -1, 2) . '</b> </td> </tr>';
        }
        ...
        if ($total_ending_balance >= 0){
            ...
            $output .= '<td class="text-right"><h5><b>' . number_format($total_ending_balance * -1, 2) . '</b></h5></td></tr></thead></table>';
        }
