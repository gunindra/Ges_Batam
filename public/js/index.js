(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            empty: 'Attention, data jangan kosong. ',
            minLength: 'Attention, min 5 huruf atau angka.',
            maxLength: 'Attention, max 30 huruf atau angka .',
            max: 'Attention, max 1000.',
            email: 'Attention! .',
            exists: 'Attention, data yang dimasukkan sudah ada !',
            autocomplete_only: 'Attention! .',
            timeout: 8000
        }
    };
