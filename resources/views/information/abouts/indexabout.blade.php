...
<div class="modal fade" id="modalGambar" tabindex="-1" role="dialog"
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">About dan Why</h1>
        </div>
        <div class="row mb-3">
        <div class="col-xl-6">
            <div class="card">
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="containerWhyUs" class="table-responsive px-3">
                            <table class="table align-items-center table-flush table-hover" id="tableWhyUs">
                                <thead class="thead-light">
                                    <tr>
                                        <th>No.</th>
                                        <th>Paraf Why</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>1.</td>
                                        <td>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Distinctio natus aspernatur eligendi, aperiam voluptatibus quia! Facere eveniet consequuntur nostrum molestias, asperiores cupiditate quibusdam dolore molestiae quod modi? Assumenda, tenetur repudiandae?</td>
                                        <td><img src="/img/Whyus.jpg" width="50px"></td>
                                        <td>
                                        <a href="#" class="btn btn-sm btn-secondary"><i
                                                    class="fas fa-edit"></i></a>
                                            <a href="#" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
