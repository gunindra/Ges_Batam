        ...
        for (var i = 0; i < invoiceNumbers.length; i++) {
            ...
            if (metodePengiriman !== 'Pickup') {
                if (buktiPengantaran[i] && buktiPengantaran[i] !== 'Tidak Ada Bukti') {
                    modalContent += '<td><a href="/storage/' + buktiPengantaran[i] + '" target="_blank">Lihat Bukti</a></td>';
                } else {
                    modalContent += '<td>Tidak Ada Bukti</td>';
                }
                if (tandaTangan[i] && tandaTangan[i] !== 'Tidak Ada Tanda Tangan') {
                    modalContent += '<td><a href="/storage/' + tandaTangan[i] + '" target="_blank">Lihat Tanda Tangan</a></td>';
                } else {
            ...
            modalContent += '<td><span class="badge ' + statusBadgeClass + '">' + statusInvoice[i] + '</span></td>';
