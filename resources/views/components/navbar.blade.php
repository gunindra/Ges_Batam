    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link btn {{ request()->is('Services')? 'active' : '' }}" onclick="scrollToSection('Services')" >Service</a>
                </li>
                @if (!Route::is('Services') && !Route::is('Services1') && !Route::is('Services2'))
                <li class="nav-item">
                    <a class="nav-link btn {{ request()->is('#Contact')  ? 'active' : '' }}"  onclick="scrollToSection('Contact')">Contact Us</a>
                </li>
                @endif
                @endif
                <li class="nav-item">
