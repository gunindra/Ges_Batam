...
@section('main')
    ...
    <div class="container-fluid" id="container-wrapper">
        ...
        <div class="modal fade" id="modalDetailInvoice" tabindex="-1" role="dialog" aria-labelledby="modalDetailInvoiceTitle"
            aria-hidden="true">
                    ...
                    <div class="card-body">
                        <div class="d-flex mb-2 mr-3 float-right">
                            ...
                            <a class="btn btn-primary" id="" href="{{ route('addSupplierInvoice') }}"><span
                                    class="pr-2"><i class="fas fa-plus"></i></span>Tambah Invoice</a>
                        </div>
    ...
    <script>
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        ...
                        response.items.forEach(function(item) {
                            var row = '<tr>' +
                                ...
                                '<td>' + currencyFormatter.format(parseFloat(item
                                    .debit)) + '</td>' +
                                '<td>' + currencyFormatter.format(parseFloat(item
                                    .credit)) + '</td>' +
                                '</tr>';
            ...
            $(document).on('click', '.btnEditInvoice', function() {
                let id = $(this).data('id');
                window.location.href = '/vendor/supplierInvoice/edit/' + id;
            });
            ...
            $(document).on('click', '.btnDeleteInvoice', function() {
                ...
                Swal.fire({
                    ...
                    text: "Data invoice dan jurnal terkait akan dihapus!",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: `/vendor/supplierInvoice/destroy/${invoiceId}`,
                            type: "DELETE",
                            data: {
                            ...
                            success: function(response) {
                                ...
                                // Refresh tabel atau halaman jika diperlukan
                                table.ajax.reload();
                            },
                            error: function(xhr) {
