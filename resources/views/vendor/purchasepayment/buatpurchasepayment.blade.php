            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mt-3">
                            ...
                            <div id="errInvoicePayment" class="text-danger mt-1 d-none">Silahkan Pilih No. Voucher</div>
                        </div>
                        <div class="mt-3">
                ...
                <div class="col-12 mt-4 mb-5">
                    <div class="col-4 float-right">
                        <button id="buatPayment" class="btn btn-primary p-3" style="width: 100%;">Buat Payment</button>
                    </div>
                </div>
            </div>
        </div>
