                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex mb-2 mr-3 float-right">
                            <a class="btn btn-primary" href="{{ route('addDebitNote') }}" id=""><span
                                    class="pr-2"><i class="fas fa-plus"></i></span>Buat Debit Note</a>
                        </div>
                        ...
                        <div id="containerDebitNote" class="table-responsive px-3">
                            <table id="debitNoteTable" class="table align-items-center table-flush table-hover">
...
@section('script')
    <script>
        $(document).ready(function() {
            var table = $('#debitNoteTable').DataTable({
                serverSide: true,
                ajax: {
                    url: "{{ route('getDebitNotes') }}",
                    type: 'GET',
                    data: function(d) {
                ...
                columns: [
                    { data: 'no_debitnote', name: 'dn.no_debitnote' },
                    { data: 'invoice', name: 'inv.no_invoice' },
                    { data: 'coa_name', name: 'coa.name' },
                    { data: 'currency', name: 'mu.singkatan_matauang' },
                    { data: 'tanggal', name: 'dn.created_at' },
            ...
            $(document).on('click', '.btnedit', function(e) {
                e.preventDefault();
                let id = $(this).data('id');
                var url = "{{ route('debitnote.updatepage', ':id') }}";
