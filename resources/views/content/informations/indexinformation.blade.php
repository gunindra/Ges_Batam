                    ...
                    <div class="modal-body">
                        <form id="informationForm" enctype="multipart/form-data">
                            ...
                            <div class="mt-3">
                                ...
                                <textarea class="form-control" id="contentInformations" rows="3" placeholder="Masukkan content"></textarea>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            <label for="contentInformations" class="form-label fw-bold">Content</label>
                            <textarea class="form-control" id="contentInformationsEdit" rows="3" placeholder="Masukkan content"></textarea>
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if (response.success) {
                                        ...
                                        .message); // Menggunakan message dari respons
