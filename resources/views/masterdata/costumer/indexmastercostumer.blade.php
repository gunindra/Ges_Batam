                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mt-3">
                                    <label for="emailCustomerEdit" class="form-label fw-bold">Email</label>
                                    <input type="email" class="form-control" id="emailCustomerEdit" value=""
                                        placeholder="Masukkan email customer">
                                    <div id="emailCustomerErrorEdit" class="text-danger mt-1 d-none">Silahkan isi email
                                        customer</div>
                                </div>
                                <div class="mt-3">
                                    <label for="passwordCustomerEdit" class="form-label fw-bold">Password</label>
                                    <input type="password" class="form-control" id="passwordCustomerEdit" value=""
                                        placeholder="Masukkan password">
                                    <div id="passwordCustomerErrorEdit" class="text-danger mt-1 d-none">Silahkan isi
                                        password customer</div>
                                </div>
                                <div class="mt-3">
