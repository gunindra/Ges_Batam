...
@section('main')
    ...
    <div class="container-fluid" id="container-wrapper">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mt-3">
                            ...
                            <input type="text" class="form-control" id="roleMaster" value=""
        ...
        <div class="modal fade" id="modalMenuAkses" tabindex="-1" role="dialog"
            aria-labelledby="modalTambahMenuAksesTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
