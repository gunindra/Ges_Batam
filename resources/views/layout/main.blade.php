...
@section('content')
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
        ...
        <li class="nav-item {{ request()->routeIs('costumer') || request()->routeIs('driver') || request()->routeIs('rekening') ? 'active' : '' }}">
            ...
            <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item {{ request()->routeIs('costumer') ? 'active' : '' }}" href="{{ route('costumer') }}">Costumers</a>
                    <a class="collapse-item {{ request()->routeIs('driver') ? 'active' : '' }}" href="{{ route('driver') }}">Driver</a>
                    <a class="collapse-item {{ request()->routeIs('rekening') ? 'active' : '' }}" href="{{ route('rekening') }}">Rekening</a>
                </div>
            </div>
        </li>
