                            ...
                            <div class="col-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <select class="form-control select2singgle" id="selectCostumer" style="width: 67%">
                                        ...
                                        <?php $__currentLoopData = $listPembeli; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembeli): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($pembeli->id); ?>">
                                                <?php echo e($pembeli->marking); ?> - <?php echo e($pembeli->nama_pembeli); ?></option>
                                            ...
                                            <select class="form-control" id="rateBerat">
                                                ...
                                                <?php $__currentLoopData = $listRateVolume; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($rate->rate_for == 'Berat'): ?>
                                                        <option value="<?php echo e($rate->nilai_rate); ?>">
                                ...
                                <div class="d-flex flex-row mt-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <select class="form-control" id="pembagiVolume">
                                            ...
                                            <?php $__currentLoopData = $lisPembagi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembagi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($pembagi->nilai_pembagi); ?>">
                            ...
                            <div class="col-4">
                                <div class="mt-3" id="driverSection" style="display: none;">
                                    ...
                                    <select class="form-control select2singgle col-8" id="driver" style="width: 100%">
                                        ...
                                        <?php $__currentLoopData = $listSupir; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supir): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($supir->id); ?>">
                                                <?php echo e($supir->nama_supir); ?> - <?php echo e($supir->no_wa); ?>
                            ...
                            <div class="col-4">
                                <div class="mt-3">
                                    ...
                                    <select class="form-control" id="metodePembayaran">
                                        ...
                                        <?php $__currentLoopData = $listTipePembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipepembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($tipepembayaran->id); ?>">
                                                <?php echo e($tipepembayaran->tipe_pembayaran); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="col-6">
                                <div class="mt-3" id="rekeningSection" style="display: none;">
                                    ...
                                    <select class="form-control select2singgle col-8" id="rekening" style="width: 67%">
                                        ...
                                        <?php $__currentLoopData = $listRekening; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rekening): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($rekening->id); ?>">
                                                <?php echo e($rekening->pemilik); ?> - <?php echo e($rekening->nomer_rekening); ?> |
                                                <?php echo e($rekening->nama_bank); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#buatInvoice').click(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('tambainvoice')); ?>",
                    data: {
                        noResi: noResi,
                        tanggal: tanggal,
                        customer: customer,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\customer\invoice\deleteoreditinvoice.blade.php ENDPATH**/ ?>