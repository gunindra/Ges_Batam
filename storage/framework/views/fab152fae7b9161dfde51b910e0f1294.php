...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('invoice')); ?>">Invoice</a></li>
                    ...
                    <div class="d-flex flex-row">
                        <div class="col-6">
                            <div class="mt-3">
                                ...
                                <div class="d-flex">
                                    <h2 class="fw-bold" id="noInvoice"><?php echo e($invoice->no_invoice); ?></h2>
                                </div>
                            </div>
                            <div class="mt-3">
                        ...
                        <div class="col-6">
                            <div class="mt-3">
                                ...
                                <select class="form-control select2singgle" id="selectCostumer" style="width: 67%">
                                    ...
                                    <?php $__currentLoopData = $listAlamat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alamat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($alamat->id); ?>" data-metode="<?php echo e($alamat->metode_pengiriman); ?>"
                                            data-alamat="<?php echo e($alamat->alamat); ?>"
                                            data-jumlahalamat="<?php echo e($alamat->jumlah_alamat); ?>"
                                            data-minrate="<?php echo e($alamat->minimum_rate ?? 0); ?>"
                                            data-maxrate="<?php echo e($alamat->maximum_rate ?? 0); ?>">
                                            <?php echo e($alamat->marking); ?> - <?php echo e($alamat->nama_pembeli); ?>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <select class="form-control" id="rateBerat">
                                ...
                                <?php $__currentLoopData = $listRateBerat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($rate->rate_for == 'Berat'): ?>
                                        <option value="<?php echo e($rate->id); ?>" data-nilai-rate="<?php echo e($rate->nilai_rate); ?>" <?php if($rate->id == $invoice->rateberat_id): ?> selected <?php endif; ?>>
                                            <?php echo e(number_format($rate->nilai_rate, 0, ',', '.')); ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select class="form-control" id="pembagiVolume">
                                ...
                                <?php $__currentLoopData = $listPembagi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembagi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pembagi->id); ?>" data-nilai-pembagi="<?php echo e($pembagi->nilai_pembagi); ?>">
                                        <?php echo e(number_format($pembagi->nilai_pembagi, 0, ',', '.')); ?>
                    ...
                    <div class="form-group row mt-3">
                        <div class="col-sm-6">
                            ...
                            <select class="form-control" id="rateVolume">
                                <option value="" selected disabled>Pilih Rate</option>
                                <?php $__currentLoopData = $listRateVolume; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($rate->rate_for == 'Volume'): ?>
                                        <option value="<?php echo e($rate->id); ?>" data-nilai-ratevolume="<?php echo e($rate->nilai_rate); ?>" <?php if($rate->id == $invoice->ratevolume_id): ?> selected <?php endif; ?>>
                                            <?php echo e(number_format($rate->nilai_rate, 0, ',', '.')); ?>
        ...
        $('#scanNoresi').on('keydown', function (event) {
            if (event.key === "Enter" || event.keyCode === 13) {
                ...
                if (isAlreadyInTable) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('cekResiInvoice')); ?>",
                        method: 'GET',
                        data: {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\customer\invoice\deleteoreditinvoice.blade.php ENDPATH**/ ?>