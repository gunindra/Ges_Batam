    ...
    <script>
        $(document).ready(function() {
            ...
            const getlistPickup = () => {
                ...
                $.ajax({
                        url: "<?php echo e(route('getlistPickup')); ?>",
                        method: "GET",
                        data: {
                            txSearch: txtSearch,
                            status: filterStatus,
            ...
            $(document).on('click', '.btnPickup', function(e) {
                ...
                Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                type: "POST",
                                url: "<?php echo e(route('acceptPickup')); ?>",
                                data: {
                                    id: id,
                                },
                                headers: {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\customer\pickup\indexpickup.blade.php ENDPATH**/ ?>