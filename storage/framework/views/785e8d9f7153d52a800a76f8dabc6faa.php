...
<?php endif; ?>
    ...
    <div class="containers">
        <div class="footer-content">
            <h3>Contact</h3>
            <p>Email: <?php echo e($dataPtges->email ?? '-'); ?></p>
            <p>Phone (main): <?php echo e(is_object($dataPtges) && isset($dataPtges->phone) ? '+62' . $dataPtges->phone : '-'); ?></p>
            <p>Phone (Second): <?php echo e(is_object($dataPtges) && isset($dataPtges->phones) ? '+62' . $dataPtges->phones : '-'); ?></p>
        </div>
        <div class="footer-content">
            <h3>Quick Links</h3>
            <ul class="list">
...
<?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views/components/footer.blade.php ENDPATH**/ ?>