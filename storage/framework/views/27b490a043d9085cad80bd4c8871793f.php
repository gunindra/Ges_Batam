...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('journal')); ?>">Journal</a></li>
            <li class="breadcrumb-item active" aria-current="page">Buat Journal</li>
        </ol>
    </div>
    <a class="btn btn-primary mb-3" href="<?php echo e(route('journal')); ?>">
...
<script>
        ...
        function checkAndHideBKKOption() {
            ...
            if (codeType === 'BKK') {
                ...
                function generateNoJournalBKK() {
                    $.ajax({
                        url: "<?php echo e(route('generateNoJournalBKK')); ?>",
                        type: 'GET',
                        dataType: 'json',
                        beforeSend: function () {
                ...
                $('input[name="code_type"]').change(function () {
                    ...
                    if (selectedType) {
                        $.ajax({
                            url: "<?php echo e(route('generateNoJurnal')); ?>",
                            method: 'GET',
                            data: {
                ...
                function generateNoJournalBKM() {
                    $.ajax({
                        url: "<?php echo e(route('generateNoJournalBKM')); ?>",
                        type: 'GET',
                        dataType: 'json',
                        beforeSend: function () {
                            $('#noJournal').val('Loading...');
    ...
    `;
        ...
        $('#approveJournal').click(function () {
            ...
            $.ajax({
                url: "<?php echo e(route('storeJurnal')); ?>",
                type: 'POST',
                data: journal,
                headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\accounting\journal\indexbuatjournal.blade.php ENDPATH**/ ?>