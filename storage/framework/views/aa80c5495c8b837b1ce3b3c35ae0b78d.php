                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            <div class="col-12">
                                ...
                                <a href="<?php echo e(route('asset.createJournalForDepreciation')); ?>" class="btn btn-secondary add-new btn-primary waves-effect waves-light">
                                    <span><i class="ri-add-line ri-16px me-0 me-sm-2 align-baseline"></i>
                                        <span class="d-none d-sm-inline-block"><?php echo e(trans('brand.Add Brands')); ?></span>
                                    </span>
                                </a>
                            </div>
