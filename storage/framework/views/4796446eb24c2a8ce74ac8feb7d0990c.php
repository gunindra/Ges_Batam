            ...
            <div class="card col-lg-8 col-md-10 col-sm-12 mb-4" style="margin-top:100px; border-radius:20px;">
                <div class="card-body text-center">
                    <div class="d-flex justify-content-center mb-5">
                        <img src="<?php echo e(asset('storage/images/' . $dataService[0]->image_service)); ?>" alt="<?php echo e($dataService[0]->title_service); ?>" class="img-fluid" style="max-width: 100%; height: 500px; border-radius:20px;">
                    </div>
                    <div class="col-12">
                        <h3 class="text-primary"><?php echo e($dataService[0]->title_service); ?></h3>
                        <p><?php echo e($dataService[0]->content_service); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\landingpage\Services.blade.php ENDPATH**/ ?>