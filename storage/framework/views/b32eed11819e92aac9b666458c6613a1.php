        ...
        <table>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $topup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topups): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($no++); ?></td>
                        <td> <?php echo e(\Carbon\Carbon::parse( $topups->date)->format('d M Y')); ?></td>
                        <td> <?php echo e($topups->customer_name); ?></td>
                        <td><?php echo e($topups->remaining_points); ?></td>
                        <td><?php echo e($topups->remaining_points - $topups->balance); ?></td>
                        <td><?php echo e($topups->balance); ?></td>
                        <td><?php echo e($topups->status); ?></td>
                    </tr>
...
<?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\exportPDF\topupreport.blade.php ENDPATH**/ ?>