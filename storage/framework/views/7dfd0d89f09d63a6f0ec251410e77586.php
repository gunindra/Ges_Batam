            ...
            if (isValid) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('addInformations')); ?>",
                            data: formData,
                            contentType: false,
                            processData: false,
                ...
                if (isValid) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo e(route('updateInformations')); ?>",
                                data: formData,
                                contentType: false,
                                processData: false,
                                success: function (response) {
        ...
        $(document).on('click', '.btnDestroyInformations', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('destroyInformations')); ?>",
                        data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\content\informations\indexinformation.blade.php ENDPATH**/ ?>