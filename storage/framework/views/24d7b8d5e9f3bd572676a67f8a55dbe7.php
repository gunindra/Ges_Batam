<?php $__env->startSection('title', 'Master Data | Driver'); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea class="form-control" id="alamatDriver" rows="3"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        <label for="alamat" class="form-label fw-bold">Alamat</label>
                        <textarea class="form-control" id="alamatDriverEdit" rows="3"
                            placeholder="Masukkan alamat"></textarea>
...
<script>
    $(document).ready(function () {
        ...
        const getListDriver = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('getlistDriver')); ?>",
                method: "GET",
                data: {
                    txSearch: txtSearch
                },
            ...
            if (isValid) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('addDriver')); ?>",
                            data: formData,
                            contentType: false,
                            processData: false,
...
$(document).on('click', '.btnUpdateDriver', function (e) {
    ...
    $(document).on('click', '#saveEditDriver', function (e) {
        ...
        if (simDriverEdit && simDriverEdit !== '') {
            var validExtensions = ['image/jpeg', 'image/jpg', 'image/png'];
            if (!validExtensions.includes(simDriverEdit.type)) {
                $('#simDriverEditError').text('Hanya file JPG, JPEG, atau PNG yang diperbolehkan').removeClass('d-none');
                isValid = false;
            } else {
        ...
        if (isValid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: 'Checking...',
                        html: 'Please wait while we process your driver data update.',
                        allowOutsideClick: false,
                        didOpen: () => {
                            Swal.showLoading();
                        }
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('updateDriver')); ?>",
                        data: formData,
                        contentType: false,
                        processData: false,
                        success: function (response) {
        ...
        $(document).on('click', '.btnDestroyDriver', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(route('destroyDriver')); ?>",
                        data: {
                            id: id,
                        },
                        success: function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\masterdata\driver\indexmasterdriver.blade.php ENDPATH**/ ?>