<?php $__env->startSection('title', 'Master Data | Costumer'); ?>
                            ...
                            <div id="alamatSection">
                                <div id="alamatContainer">
                                    <div class="mt-3 alamat-item">
                                        ...
                                        <textarea class="form-control" name="alamatCustomer[]"
                            ...
                            <div id="alamatSectionEdit">
                                <div id="alamatContainerEdit">
                                    <div class="mt-3 alamat-item">
                                        ...
                                        <textarea class="form-control" name="alamatCustomerEdit[]"
                                            placeholder="Masukkan alamat" rows="3"></textarea>
                                        <div class="text-danger mt-1 d-none alamat-error">Silahkan isi alamat customer
                                        </div>
                                        <button type="button" class="btn btn-danger btn-sm mt-2 remove-alamat-btn"
...
<script>
    $(document).ready(function () {
        ...
        const getListCustomer = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('getlistCostumer')); ?>",
                method: "GET",
                data: {
                    txSearch: txtSearch,
                    status: filterStatus
        ...
        $(document).on('click', '#modalTambahCost', function (e) {
            $.ajax({
                type: "GET",
                url: "<?php echo e(route('generateMarking')); ?>",
            ...
            if (isValid) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('addCostumer')); ?>",
                            data: formData,
                            contentType: false,
                            processData: false,
                            success: function (response) {
            ...
            if (isValid) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('updateCostumer')); ?>",
                            data: formData,
                            contentType: false,
                            processData: false,
                            success: function (response) {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views/masterdata/costumer/indexmastercostumer.blade.php ENDPATH**/ ?>