                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-2 mr-3 float-right">
                                        <a class="btn btn-primary" href="<?php echo e(route('addjournal')); ?>?code_type=Jurnal">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex mb-2 mr-3 float-right">
                                        <a class="btn btn-primary" href="<?php echo e(route('addjournal')); ?>?code_type=BKK"
                                            id="">
                                            <span class="pr-2"><i class="fas fa-plus"></i></span>Buat Journal
                                        </a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="d-flex mb-2 mr-3 float-right">
                                        <a class="btn btn-primary" href="<?php echo e(route('addjournal')); ?>?code_type=BKM" id=""><span
    ...
    $(document).ready(function () {
        function initTableJournal(tipeKode, excludeTypes = []) {
            return $('#tableJournal' + (tipeKode || '')).DataTable({
                ...
                processing: true,
                ajax: {
                    url: "<?php echo e(route('journal.data')); ?>",
                    method: 'GET',
                    data: function (d) {
        ...
        $(document).on('click', '.btnUpdateJournal', function (e) {
            ...
            let id = $(this).data('id');
            var url = "<?php echo e(route('updatejournal', ':id')); ?>";
        ...
        $(document).on('click', '.btnDestroyJournal', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "<?php echo e(route('destroyJurnal', ':id')); ?>".replace(':id', id),
                        type: 'DELETE',
                        headers: {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\accounting\journal\indexjournal.blade.php ENDPATH**/ ?>