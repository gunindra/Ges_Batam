            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <p>Nama Image = <span id="imageName"><?php echo e($aboutData->Image_AboutUs ?? ' -'); ?></span></p>
                    </div>
                    ...
                    <div class="preview" id="previewContainer"
                        ...
                        <?php if($aboutData): ?>
                            <?php if($aboutData->Image_AboutUs): ?>
                                ...
                                <p style="margin-left:30px;"><?php echo nl2br( e( $aboutData->Paragraph_AboutUs ?? '' )); ?></p>
                            <?php endif; ?>
                        <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\content\abouts\indexabout.blade.php ENDPATH**/ ?>