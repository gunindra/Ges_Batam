...
<script>
    $(document).ready(function () {
        var journalData = <?php echo json_encode($journal, 15, 512) ?>;
        ...
        $('#approveJournal').click(function () {
            ...
            let id = $(this).data('id');
            $.ajax({
                url: "<?php echo e(route('buatupdate', ':id')); ?>".replace(':id', id),
                type: 'PUT',
                data: journal,
                headers: {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\accounting\journal\indexupdatejournal.blade.php ENDPATH**/ ?>