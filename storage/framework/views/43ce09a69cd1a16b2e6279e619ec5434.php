...
<body>
    <div class="container">
        ...
        <div class="title">
            ...
            <h5>Metode Pembayaran:  <?php echo e($account ? $account : '-'); ?></h5>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($no++); ?></td>
                        <td> <?php echo e($kas->kode_pembayaran); ?></td>
                        <td> <?php echo e(\Carbon\Carbon::parse( $kas->created_date)->format('d M Y')); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($kas->payment_date )->format('d M Y')); ?></td>
                        <td><?php echo e($kas->customer_name); ?></td>
                        <td><?php echo e($kas->payment_method); ?></td>
                        <td><?php echo e($kas->no_invoice_with_amount); ?></td>
                        <td><?php echo e($kas->total_amount - $kas->discount); ?></td>
                    </tr>
...
<?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\exportPDF\penerimaankaspdf.blade.php ENDPATH**/ ?>