            ...
            if (isValid) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('addPembagi')); ?>",
                            data: formData,
                            contentType: false,
                            processData: false,
                ...
                if (isValid) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo e(route('updatePembagi')); ?>",
                                data: formData,
                                contentType: false,
                                processData: false,
                                success: function (response) {
        ...
        $(document).on('click', '.btnDestroyPembagi', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(route('destroyPembagi')); ?>",
                        data: {
                            id: id,
                        },
                        success: function (response) {
                ...
                if (isValid) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo e(route('updateRate')); ?>",
                                data: formData,
                                contentType: false,
                                processData: false,
                                success: function (response) {
        ...
        $(document).on('click', '.btnDestroyRate', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(route('destroyRate')); ?>",
                        data: {
                            id: id,
                        },
                        success: function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\masterdata\pembagirate\indexpembagirate.blade.php ENDPATH**/ ?>