...
<script>
    $(document).ready(function () {
        let table = $('#tablePeriode').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('getPeriode')); ?>",
                type: 'GET',
                data: function (d) {
        ...
        function generatePeriode() {
            $.ajax({
                url: "<?php echo e(route('generatePeriode')); ?>",
                type: 'GET',
                dataType: 'json',
                beforeSend: function () {
                    $('#periode').val('Loading...');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\masterdata\periode\indexmasterperiode.blade.php ENDPATH**/ ?>