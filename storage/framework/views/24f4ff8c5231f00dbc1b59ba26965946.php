...
<script>
    $(document).ready(function () {
        ...
        let table = $('#tableTopup').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('topup.data')); ?>",
                type: 'GET',
                data: function (d) {
        ...
        function generateCodeVoucher() {
            $.ajax({
                url: "<?php echo e(route('generateCodeVoucher')); ?>",
                type: 'GET',
                dataType: 'json',
                beforeSend: function () {
                    $('#Voucher').val('Loading...');
        ...
        $('#confirmTopUp').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('topup-points')); ?>",
                method: 'POST',
                data: {
        ...
        $(document).on('click', '.btnCancelTopup', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('cancleTopup')); ?>",
                        type: 'POST',
                        data: {
                            topup_id: id,
                            _token: '<?php echo e(csrf_token()); ?>'
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\topup\indextopup.blade.php ENDPATH**/ ?>