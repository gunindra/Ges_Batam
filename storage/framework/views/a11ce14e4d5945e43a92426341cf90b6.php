        ...
        <table class="driver-info">
            <tr>
                ...
                <td style="text-align: right;">
                    <h5>Tanggal : <?php echo e($pengantaran->tanggal_pengantaran); ?></h5>
                </td>
            </tr>
        </table>
                    ...
                    <td class="invoice-column">
                        <table class="driver-info">
                            <tr>
                                <td>
                                    <div>
                                        <h5>Penerima: <?php echo e($invoice->nama_pembeli); ?></h5>
                                        <h5>Alamat: <?php echo e($invoice->alamat); ?></h5>
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <h5 class="text-right">Invoice: <?php echo e($invoice->no_invoice); ?></h5>
                                    </div>
                                </td>
                            </tr>
                        </table>
...
<?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\exportPDF\deliverylist.blade.php ENDPATH**/ ?>