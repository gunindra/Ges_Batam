<?php $__env->startSection('content'); ?>
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li
                class="nav-item <?php echo e(request()->routeIs('invoice') || request()->routeIs('delivery') || request()->routeIs('pickup') ? 'active' : ''); ?>">
                ...
                <div id="customerMenu" class="collapse" aria-labelledby="headingBootstrap"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php echo e(request()->routeIs('delivery') ? 'active' : ''); ?>"
                            href="<?php echo e(route('delivery')); ?>">Delivery</a>
            ...
            <li
            class="nav-item <?php echo e(request()->routeIs('vendor')? 'active' : ''); ?>">
            ...
            <li
                class="nav-item <?php echo e(request()->routeIs('costumer') || request()->routeIs('driver') || request()->routeIs('rekening') || request()->routeIs('pembagirate') || request()->routeIs('category') ? 'active' : ''); ?>">
                ...
                <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php echo e(request()->routeIs('rekening') ? 'active' : ''); ?>"
                            href="<?php echo e(route('rekening')); ?>">Rekening</a>
                        ...
                        <a class="collapse-item <?php echo e(request()->routeIs('role') ? 'active' : ''); ?>"
                            href="<?php echo e(route('role')); ?>">Role</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo e(asset('RuangAdmin/img/man.png')); ?>"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<?php echo e(asset('RuangAdmin/img/girl.png')); ?>"
                                            style="max-width: 60px" alt="">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('verification.notice')); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\layout\main.blade.php ENDPATH**/ ?>