                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="d-flex mb-2 mr-3 float-right">
                            ...
                            <a class="btn btn-primary" href="<?php echo e(route('addCreditNote')); ?>" id=""><span
    ...
    <script>
        $(document).ready(function() {
            var table = $('#creditNoteTable').DataTable({
                ...
                processing: true,
                ajax: {
                    url: "<?php echo e(route('getCreditNotes')); ?>",
                    type: 'GET',
                    data: function(d) {
            ...
            $(document).on('click', '.btnedit', function(e) {
                e.preventDefault();
                let id = $(this).data('id');
                var url = "<?php echo e(route('updatepage', ':id')); ?>";
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\customer\creditnote\indexcreditnote.blade.php ENDPATH**/ ?>