<?php $__env->startSection('title', 'Buat Delivery'); ?>
...
<div class="modal fade" id="inputResiPickupModal" tabindex="-1" aria-labelledby="inputResiPickupModalLabel"
            ...
            <div class="modal-body">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <select class="form-control ml-2" id="filterMarkingPickup" style="width: 200px;">
                        <option value="" selected disabled>Pilih Marking</option>
                        <?php $__currentLoopData = $listMarkingPickup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $marking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($marking->marking); ?>"><?php echo e($marking->marking); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <select class="form-control ml-2" id="filterNoDoPickup" style="width: 200px;">
                        <option value="" selected disabled>Pilih NoDo</option>
                        <?php $__currentLoopData = $listNoDoPickup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($nodo->no_do); ?>"><?php echo e($nodo->no_do); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <button type="button" class="btn btn-outline-primary ml-2" id="btnResetDefault"
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('delivery')); ?>">Delivery</a></li>
                <li class="breadcrumb-item active" aria-current="page">Buat Delivery</li>
            </ol>
        </div>

        <a class="btn btn-primary mb-3" href="<?php echo e(route('delivery')); ?>">
    ...
    <script>
        ...
        const getlistTableBuatDelivery = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('getlistTableBuatDelivery')); ?>",
                method: "GET",
                data: {
                    txSearch: txtSearch,
        ...
        $('#confirmSelection').on('click', function () {
            ...
            const csrfToken = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: "<?php echo e(route('cekResiBulk')); ?>",
                method: 'POST',
                data: {
                    _token: csrfToken,
        ...
        $('#buatDelivery').on('click', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('buatDelivery')); ?>",
                method: 'POST',
                data: {
    ...
    <script>
        const getlistTableBuatPickup = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('getlistTableBuatPickup')); ?>",
                method: "GET",
                data: {
        ...
        $('#tambah_pickup').on('click', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('cekResiPickup')); ?>",
                method: 'POST',
                data: {
                    _token: csrfToken,
        ...
        $('#confirmSelectionPickup').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('cekResiBulkPickup')); ?>",
                method: 'POST',
                data: {
                    _token: csrfToken,
        ...
        $('#buatPickup').on('click', function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('buatPickup')); ?>",
                method: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\customer\delivery\buatdelivery.blade.php ENDPATH**/ ?>