                    ...
                    <div class="d-flex flex-row">
                        <div class="col-6">
                            <div class="mt-3">
                                ...
                                <div class="d-flex">
                                    <h2 class="fw-bold" id="noInvoice"><?php echo e($newNoinvoice); ?></h2>
                            ...
                            <div class="mt-3">
                                ...
                                <select class="form-control select2singgle" id="selectCostumer" style="width: 67%">
                                    ...
                                    <?php $__currentLoopData = $listPembeli; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembeli): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($pembeli->id); ?>" data-metode="<?php echo e($pembeli->metode_pengiriman); ?>"
                                            data-minrate="<?php echo e($pembeli->minimum_rate); ?>"
                                            data-maxrate="<?php echo e($pembeli->maximum_rate); ?>" data-alamat="<?php echo e($pembeli->alamat); ?>"
                                            data-jumlahalamat="<?php echo e($pembeli->jumlah_alamat); ?>">
                                            <?php echo e($pembeli->marking); ?> - <?php echo e($pembeli->nama_pembeli); ?>
...
<script>
    $(document).ready(function () {
        $('#btnRefreshInvoice').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('generateInvoice')); ?>",
                method: 'GET',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\customer\invoice\buatinvoice.blade.php ENDPATH**/ ?>