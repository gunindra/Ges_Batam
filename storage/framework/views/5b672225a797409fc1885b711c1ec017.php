<?php $__env->startSection('title', 'Report | Statement of Account'); ?>
                                ...
                                <div class="mt-3">
                                    ...
                                    <select class="form-control select2" id="customer">
                                        ...
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($customer->id); ?>"><?php echo e($customer->marking); ?> - <?php echo e($customer->nama_pembeli); ?></option>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sendWA').on('click', function(e) {
                ...
                const pdfUrl = `<?php echo e(route('soaWA')); ?>?startDate=${startDate}&endDate=${endDate}&customer=${customer}`;
            ...
            $.ajax({
                url: "<?php echo e(route('exportSoaCustomer')); ?>",
                type: 'GET',
                data: {
                    startDate: startDate,
                    endDate: endDate,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\Report\Soa\indexbalance.blade.php ENDPATH**/ ?>