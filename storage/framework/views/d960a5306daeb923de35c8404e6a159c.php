<?php $__env->startSection('title', 'Buat Payment'); ?>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="form-control select2" id="selectMarking">
                                ...
                                <?php $__currentLoopData = $listMarking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $markingList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($markingList->marking); ?>"><?php echo e($markingList->marking); ?>

                                        (<?php echo e($markingList->nama_pembeli); ?>)
                                    </option>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mt-3">
                            ...
                            <select class="form-control select2" id="selectMethod">
                                ...
                                <?php $__currentLoopData = $savedPaymentAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadInvoicesByMarking(marking) {
                $.ajax({
                    url: "<?php echo e(route('getInvoiceByMarking')); ?>",
                    type: 'GET',
                    data: {
                        marking
                    },
            ...
            function generateKodePembayaran() {
                $.ajax({
                    url: "<?php echo e(route('generateKodePembayaran')); ?>",
                    type: 'GET',
                    dataType: 'json',
                    beforeSend: function() {
                ...
                if (isValid) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                url: "<?php echo e(route('buatpembayaran')); ?>",
                                method: 'POST',
                                data: data,
                                beforeSend: function() {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views/customer/payment/buatpayment.blade.php ENDPATH**/ ?>