...
<?php $component->withAttributes(['dataPtges' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($dataPtges ?? ''),'wa' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($wa ?? '')]); ?>
  ...
  <!-- popup -->
  <?php if(isset($popup) && ($popup->Image_Popup || $popup->title_Popup || $popup->Paragraph_Popup || $popup->Link_Popup)): ?>
    <dialog id="welcome-dialog" class="popup-dialog">
    <button id="close-popup" class="close-button">x</button>

    <?php if($popup->Image_Popup): ?>
    <img src="<?php echo e(asset('storage/images/' . $popup->Image_Popup)); ?>" alt="Popup Image" class="popup-image lazyload" loading="lazy">
  <?php endif; ?>
  ...
  <?php endif; ?>
    ...
    <p class="popup-text"><?php echo nl2br(e($popup->Paragraph_Popup)); ?></p>
  <?php endif; ?>

    <?php if($popup->Link_Popup): ?>
    <div class="controls">
      <a class="btn-Go btn btn-primary" href="<?php echo e($popup->Link_Popup); ?>"
  ...
  <div id="Home">
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
      ...
      <img class="d-block w-100 carousel-image lazyload" src="<?php echo e(asset('storage/images/' . $heropage->image_heropage)); ?>"
      alt="<?php echo e($heropage->title_heropage); ?>" loading="lazy">
      <div class="carousel-caption">
      <h5 id="judulCarousel" class="responsive-title">
        <?php echo e($heropage->title_heropage); ?>

      </h5>
      <!-- <a class="btn-responsive bg-primary bg-gradient text-white"
      href="<?php echo e(url('/Slide?id=' . $heropage->id)); ?>">Learn More</a> -->
      </div>
      </div>
...
<?php endif; ?>
  ...
  <div class="main">
    ...
    <div class="wrapperGallery <?php if(count($listinformation) == 1): ?> single-gallery <?php endif; ?>">
      ...
      alt="<?php echo e($info->title_informations ?? '-'); ?>" class="img-fluid lazyload" loading="lazy">
      <div class="img-text">
      <div class="contentGallery">
        <h2 id="titleContent"><?php echo e(Str::limit($info->title_informations ?? '-', 120, '')); ?></h2>
        <p id="paragraphContent"><?php echo e(Str::limit($info->content_informations ?? '-', 260, '')); ?></p>
      </div>
      </div>
      </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="containerAbout">
      <div class="wrapper-About">
        <div class="content">
          ...
          <p id="parafAbout"><?php echo nl2br(e(Str::limit($dataPtges->Paragraph_AboutUs ?? 'No Content Available', 200))); ?></p>
          <a href="/About" class="btn">Learn More</a>
        </div>
        <div class="image" id="imageAbout">
          <?php if(!empty($dataPtges->Image_AboutUs)): ?>
        <img src="<?php echo e(asset('storage/images/' . $dataPtges->Image_AboutUs)); ?>" style="border-radius:30px;"
    ...
    <div class="wrapperwhy" id="Why">
      <div class="why">
        <div class="image-sectionwhy">
          <?php if(!empty($dataPtges->Image_WhyUs)): ?>
    ...
    <?php endif; ?>
        ...
        <article>
          ...
          <p id="parafWhy" style=" word-break: break-word; ">
            <?php echo nl2br(e(Str::limit($dataPtges->Paragraph_WhyUs ?? 'No Content Available', 200))); ?>
  ...
  <div class="section" id="Services">
    ...
    <div id="card-area" class="wrapper">
      ...
      <div class="box">
        ...
        alt="<?php echo e($service->title_service ?? '-'); ?>" loading="lazy" class="lazyload">
        <div class="overlay">
        <div class="overlay-content">
        <h3 style="word-break: break-word;"><?php echo e(Str::limit($service->title_service ?? '-', 50, '')); ?></h3>
        <p style="word-break: break-word;">
        <?php echo nl2br(e(Str::limit($service->content_service ?? '-', 149))); ?>
  ...
  <div class="logos <?php echo e(count($listiklan) > 0 ? '' : 'hidden'); ?>" style="margin-top:50px;">
    <div class="logos-slide">
      ...
      <img src="<?php echo e(asset('storage/images/' . $iklan->image_Advertisement)); ?>"
      alt="<?php echo e($iklan->title_Advertisement ?? '-'); ?>" loading="lazy" class="lazyload">
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
  </div>
    ...
    <div class="container" style="margin-bottom:30px; margin-top:80px;">
      <div class="row justify-content-center">
        ...
        <div class="col-lg-5 col-md-12">
          ...
          <p style="color:#1679AB; font-size: 20px; font-family: sans-serif;"><?php echo e($dataPtges->alamat ?? '-'); ?></p>
          <div class="Contact-Us" style="font-size:17px; color:#1679AB;">
            <p><i class="ph ph-envelope fa-xl"></i> <?php echo e($dataPtges->email ?? '-'); ?></p>
            <p><i class="ph ph-phone fa-xl"></i>
              <?php echo e(is_object($dataPtges) && isset($dataPtges->phone) ? '+62' . $dataPtges->phone : '-'); ?></p>
            <p><i class="ph ph-phone-plus fa-xl"></i>
              <?php echo e(is_object($dataPtges) && isset($dataPtges->phones) ? '+62' . $dataPtges->phones : '-'); ?></p>
          </div>
        </div>
      </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\landingpage\PTGes.blade.php ENDPATH**/ ?>