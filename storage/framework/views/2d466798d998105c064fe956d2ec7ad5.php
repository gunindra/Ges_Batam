                        ...
                        <div class="mt-3">
                            ...
                            <select class="form-control" id="roleUsers" style="width: 466px;">
                                ...
                                <?php $__currentLoopData = $listRole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($role->role); ?>">
                ...
                if (isValid) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo e(route('updateUsers')); ?>",
                                data: formData,
                                contentType: false,
                                processData: false,
                                success: function (response) {
        ...
        $(document).on('click', '.btnDestroyUsers', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(route('destroyUsers')); ?>",
                        data: {
                            id: id,
                        },
                        success: function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\masterdata\user\indexmasteruser.blade.php ENDPATH**/ ?>