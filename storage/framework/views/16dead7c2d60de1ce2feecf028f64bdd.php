            ...
            if (isValid) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('addHeroPage')); ?>",
                            data: formData,
                            contentType: false,
                            processData: false,
        ...
        $(document).on('click', '.btnDestroyHeroPage', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('destroyHeroPage')); ?>",
                        data: {
                ...
                if (isValid) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "<?php echo e(route('updateHeroPage')); ?>",
                                data: formData,
                                contentType: false,
                                processData: false,
                                success: function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views/content/heropage/indexheropage.blade.php ENDPATH**/ ?>