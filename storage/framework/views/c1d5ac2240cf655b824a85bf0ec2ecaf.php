            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <p>Name Image= <span id="imageName"><?php echo e($popupData->Image_Popup ?? ' -'); ?></span></p>
                    </div>
                    <div class="mt-3">
                ...
                <div class="card-body">
                    ...
                    <div class="preview" id="previewContainer"
                        ...
                        <?php if($popupData): ?>
                            ...
                            <?php endif; ?>
                            <p style="padding-left:30px;"><?php echo e($popupData->Paragraph_Popup); ?></p>
        ...
        $(document).on('click', '#destroyPopup', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('destroyPopup')); ?>",
                        data: {
                            id: id,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\content\popup\indexpopup.blade.php ENDPATH**/ ?>