            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="d-flex mb-2 mr-3 float-right">
                        ...
                        <a class="btn btn-primary" href="<?php echo e(route('addPurchasePayment')); ?>" id=""><span class="pr-2"><i
...
<script>
    $(document).ready(function () {
        let table = $('#tablePurchasePayment').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('getPaymentSupData')); ?>",
                type: 'GET',
                data: function (d) {
        ...
        $('#exportBtn').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('getSupInvoiceExport')); ?>",
                type: 'GET',
                data: {
                    status: status,
                    startDate: startDate,
        ...
        $(document).on('click', '.btnviewPaymentDetails', function (e) {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(route('getInvoiceSupDetail')); ?>",
                data: {
                    id: id
                },
        ...
        $(document).on('click', '.btnEditPaymentPurchase', function(e) {
                let id = $(this).data('id');
                let url = "<?php echo e(route('editpurchasepayment', ':id')); ?>";
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views/vendor/purchasepayment/indexpurchasepayment.blade.php ENDPATH**/ ?>