...
<script>
    $(document).ready(function () {
        let table = $('#vendorTable').DataTable({
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('vendors.getVendors')); ?>",
                type: 'GET'
            },
            columns: [{
                data: 'name',
        ...
        $('body').on('click', '.editVendor', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('vendors.getVendorById')); ?>", // Route yang akan dibuat untuk mengambil data vendor
                type: "GET",
                data: {
                    id: vendorId
                }, // Kirim ID vendor
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views/masterdata/vendor/indexvendor.blade.php ENDPATH**/ ?>