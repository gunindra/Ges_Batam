<?php $__env->startSection('title', 'Master Data | Role'); ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        const getlistRole = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('getlistRole')); ?>",
                method: "GET",
                data: {
                    txSearch: txtSearch
                },
        ...
        $(document).on('click', '.btnDestroyRole', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(route('destroyRole')); ?>",
                        data: {
                            id: id,
                        },
                        success: function (response) {
        ...
        const getlistMenu = () => {
            ...
            $.ajax({
                url: "<?php echo e(route('getlistMenu')); ?>",
                method: "GET",
                data: {
                    txSearch: txtSearch
                },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\masterdata\role\indexmasterrole.blade.php ENDPATH**/ ?>