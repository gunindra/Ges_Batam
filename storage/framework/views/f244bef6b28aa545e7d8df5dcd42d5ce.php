...
<body>
    ...
    <div class="container">
        ...
        <div class="title">
            <h5>Tanggal: <?php echo e($invoice->tanggal_invoice); ?></h5>
            <h5>Pembeli: <?php echo e($invoice->nama_pembeli); ?> (<?php echo e($invoice->marking); ?>) </h5>
        ...
        <div class="summary" style="position: relative;">
            ...
            <?php if($type === 'invoice'): ?>
                ...
                ?>
                    <p class="text-right" style="margin-top: 20px;">Total Harga: <strong><?php echo e(number_format($hargaIDR, 2)); ?></strong></p>
                <?php
                } else {
...
<?php /**PATH C:\Users\ilono\OneDrive\Desktop\Project SAC\pt-ges-project\resources\views\exportPDF\notification.blade.php ENDPATH**/ ?>