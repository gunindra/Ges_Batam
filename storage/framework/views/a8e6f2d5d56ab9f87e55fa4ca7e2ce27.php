...
<script>
    ...
    const getlistTracking = () => {
        ...
        $.ajax({
            url: "<?php echo e(route('getlistTracking')); ?>",
            method: "GET",
            data: {
                txSearch: txtSearch
            },
        ...
        if (isValid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('addTracking')); ?>",
                        method: 'POST',
                        data: {
                            _token: csrfToken,
        ...
        if (isValid) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('updateTracking')); ?>",
                        method: 'POST',
                        data: {
                            _token: csrfToken,
                            id: idTracking,
    ...
    $(document).on('click', '.btnDestroyTracking', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('deleteTracking')); ?>",
                    data: {
                        id: id,
                    },
                    success: function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\OneDrive\Desktop\SAC\GES-Project\resources\views\Tracking\indextracking.blade.php ENDPATH**/ ?>